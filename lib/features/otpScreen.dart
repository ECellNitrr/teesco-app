...
class _otpScreenState extends State<otpScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> widgetList = [
      ...
      //OTP bloc
      Padding(padding: EdgeInsets.only(left: 0.0, right: 2.0),
        child: Container(
      ...
      //First OTP block
      Padding(padding: EdgeInsets.only(right: 2.0, left: 2.0),
        child: Container(
          ...
          children: <Widget>[
            Flexible(child: Column(
              ...
              children: <Widget>[
                ...
                child: Text("Type the OTP sent to",
                  style: TextStyle(
                ...
                //Timer For OTP
                Padding(padding: const EdgeInsets.only(top: 16.0,left: 175),
                child: Row(
                  children: <Widget>[
                    Icon(Icons.timer),
